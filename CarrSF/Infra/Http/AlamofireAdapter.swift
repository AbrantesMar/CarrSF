...
public final class AlamofireAdapter: HttpClientProtocol {
    ...
    public func fetchUserList(url: URL, headers: HTTPHeaders?,
                              completion: @escaping (Result<[User]?, HttpError>) -> Void) {
        session.request(url)
    ...
    public func fetchUser(url: URL,
        ...
        session.request(url, headers: headers)
            ...
            .responseDecodable(of: UserDetailsDomain.self) { [weak self] response in
    ...
    func handleApiUserResult(url: URL, headers: HTTPHeaders?,
                         result: AFDataResponse<UserDetailsDomain>,
                         completion: @escaping (Result<UserDetailsDomain, HttpError>) -> Void) {
        do {
